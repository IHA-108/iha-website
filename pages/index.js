  ...
  const projects = [
    {
      ...
      goalINR: 12000000,
      raisedINR: 4200000,
      desc: 'Decentralized hempcrete micro-block manufacturing; local jobs and reduced cement emissions.',
    },
    {
      id: 'p2',
      ...
      <main style={{ padding: 40, fontFamily: 'system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial' }}>
        ...
        <section id="about" style={{ maxWidth: 1120, margin: '28px auto 0', padding: '0 16px' }}>
          <div style={{ background: '#fff', borderRadius: 16, padding: 20, boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
            ...
            <p style={{ color: '#444', lineHeight: 1.6 }}>
              The Indian Hemp Association (IHA) is an AI-led, SDG-aligned platform accelerating India’s hemp ecosystem — from
              regenerative farming and processing to market access and financing. We convene growers, processors, investors,
              researchers, and policy partners to unlock jobs, income, and climate impact.
            </p>
            <div style={{ marginTop: 16, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 12 }}>
              <div style={{ background: '#f7faf8', borderRadius: 12, padding: 14 }}>
                ...
                <div style={{ color: '#555' }}>
                  Support <b>10,000+</b> farmers via co-ops, training, and fair contracts.
                </div>
              </div>
              <div style={{ background: '#f7faf8', borderRadius: 12, padding: 14 }}>
                <div style={{ fontWeight: 700, marginBottom: 6 }}>Vision 2030 — Climate</div>
                <div style={{ color: '#555' }}>
                  <b>1 Mt CO₂e</b> avoided/removed via hempcrete, fiber, and rotations.
                </div>
              </div>
              <div style={{ background: '#f7faf8', borderRadius: 12, padding: 14 }}>
                <div style={{ fontWeight: 700, marginBottom: 6 }}>Vision 2030 — Industry</div>
                <div style={{ color: '#555' }}>
                  Enable <b>50+</b> regional processing units and export-grade value chains.
                </div>
              </div>
              <div style={{ background: '#f7faf8', borderRadius: 12, padding: 14 }}>
                <div style={{ fontWeight: 700, marginBottom: 6 }}>Vision 2030 — Jobs</div>
                <div style={{ color: '#555' }}>
                  <b>25,000</b> direct & indirect livelihoods in rural clusters.
                </div>
              </div>
            </div>
            <div style={{ marginTop: 14, display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              <a href="#projects" style={{ background: '#235d35', color: '#fff', padding: '10px 14px', borderRadius: 12, textDecoration: 'none' }}>
                Explore Projects
              </a>
              <a href="#submit" style={{ border: '1px solid #235d35', color: '#235d35', padding: '10px 14px', borderRadius: 12, textDecoration: 'none' }}>
                Submit a Proposal
              </a>
        ...
        <section id="impact" style={{ maxWidth: 1120, margin: '24px auto 0', padding: '0 16px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 12 }}>
            {counters.map((c) => (
              <div
                key={c.label}
                style={{ background: '#fff', borderRadius: 16, padding: 18, textAlign: 'center', boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}
              >
            ...
            {projects.map((p) => {
              ...
              return (
                <div key={p.id} style={{ background: '#fff', borderRadius: 16, padding: 18, boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
                  ...
                  <a
                    href="mailto:info@indianhempassociation.com?subject=IHA%20Project%20Backing%20Enquiry"
                    style={{ display: 'block', textAlign: 'center', marginTop: 12, background: '#235d35', color: '#fff', padding: '10px 12px', borderRadius: 12, textDecoration: 'none' }}
                  >
        ...
        <section id="submit" style={{ maxWidth: 1120, margin: '32px auto 0', padding: '0 16px' }}>
          <div style={{ background: '#fff', borderRadius: 16, padding: 18, boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
            ...
            <textarea
              rows={5}
              placeholder="Describe your project, team, market linkages, and timeline..."
              style={{ border: '1px solid #ddd', borderRadius: 12, padding: '10px 12px', width: '100%', marginTop: 10 }}
            />
            <div style={{ display: 'flex', gap: 10, marginTop: 10, flexWrap: 'wrap' }}>
              <a
                href="mailto:info@indianhempassociation.com?subject=IHA%20Project%20Submission&body=Please%20attach%20a%20one-pager%20and%20your%20contacts."
                style={{ background: '#111', color: '#fff', padding: '10px 12px', borderRadius: 12, textDecoration: 'none' }}
              >
                Send Submission (Email)
              </a>
              <a
                href={whatsappHref + '?text=I%20want%20to%20submit%20a%20hemp%20project%20to%20IHA'}
                style={{ border: '1px solid #235d35', color: '#235d35', padding: '10px 12px', borderRadius: 12, textDecoration: 'none' }}
              >
                Chat on WhatsApp
              </a>
            </div>
            <div style={{ fontSize: 12, color: '#666', marginTop: 6 }}>MVP preview. We’ll hook this to an AI form + review workflow soon.</div>
          </div>
        </section>
        ...
        <section id="partners" style={{ maxWidth: 1120, margin: '32px auto 40px', padding: '0 16px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16 }}>
            {[
              { title: 'EIHA (Europe)', desc: 'Policy & standards exchange, cross-market access, and joint research pipelines.' },
              { title: 'HIA / NHGA (North America)', desc: 'Farmer representation, market development, and compliance insights.' },
              { title: 'IFCHA (Global)', desc: 'International coordination, UN-aligned advocacy, and multi-country projects.' },
            ].map((t) => (
              <div key={t.title} style={{ background: '#fff', borderRadius: 16, padding: 18, boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
                <div style={{ fontWeight: 800 }}>{t.title}</div>
                <p style={{ fontSize: 14, color: '#555', marginTop: 6 }}>{t.desc}</p>
                <a href="#contact" style={{ fontSize: 14, color: '#235d35', textDecoration: 'none' }}>
          ...
          >
            <div>
              ...
              <p style={{ color: '#666', marginTop: 6 }}>
                AI-led ecosystem for India’s hemp future — advocacy, knowledge, collaboration, and transparent project funding.
              </p>
            </div>
        ...
        <div
          style={{ position: 'fixed', right: 16, bottom: 16, zIndex: 50, display: 'flex', gap: 8 }}
